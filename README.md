...
![](https://img.shields.io/badge/Total%20moves-79-blue)
![](https://img.shields.io/badge/Total%20games-2-brightgreen)
...
**:tada: Game ended! It took: 47 tries! [Click here to start new game.](https://github.com/rivenintech/rivenintech/issues/new?title=battleship%7Cnew&body=Just+push+%27Submit+new+issue%27+without+editing+the+title.+The+README+will+be+updated+after+approximately+30+seconds.)**
...
|⏰ Most recent moves|
|--------------------|
[@YousefHadder](https://github.com/YousefHadder) hit the ship at location **A2**
[@YousefHadder](https://github.com/YousefHadder) missed the ship at location **D2**
[@YousefHadder](https://github.com/YousefHadder) hit the ship at location **A1**
...
|[@YousefHadder](https://github.com/YousefHadder)|7|20|
